    ...
    return (
        <div id="result" className={style.result__container}>
            <div className={style.information}>
                ...
                {/* <p id="complect__lt" style={styleLt} className={style.text}><span className={style.spanResult}>{lt}</span><span className={style.spanResult}>{nameOflt}</span></p> */}
            ...
            <button ref={element} type="button" style={styleResult} className="result__text btn btn-primary result__btn">Выбрать комплект</button>
